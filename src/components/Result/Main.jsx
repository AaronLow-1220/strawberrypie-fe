                ...
                <div className="h-full">
                  {character.tags &&
                    character.tags.map((tag, index) => (
                      <div
                        key={index}
                        className="w-fit rounded-[999px] bg-[#51181E] text-white text-[15.4px] px-[15.4px] py-[6.6px] text-nowrap mt-[1.1rem]"
                        style={{
